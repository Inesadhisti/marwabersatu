...
<body>
  ...
  <section id="container">
    <header class="header dark-bg">
      ...
      <ul class="nav pull-right top-menu">Staff</ul>
    </header>
      ...
      <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <a href="daftarPembatikStaff.php?user=<?php echo $user; ?>">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <a href="daftarPenjahitStaff.php?user=<?php echo $user; ?>">
                <div class="info-box green-bg">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <a href="editProfileStaff.php?user=<?php echo $user; ?>">
