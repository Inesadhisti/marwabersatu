      ...
      <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <a href="daftarPembatikKoordinator.php?user=<?php echo $user; ?>">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <a href="daftarPenjahitKoordinator.php?user=<?php echo $user; ?>">
                <div class="info-box green-bg">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <a href="dataPembatikKoordinator.php?user=<?php echo $user; ?>">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <a href="dataPenjahitKoordinator.php?user=<?php echo $user; ?>">
                <div class="info-box blue-bg">
