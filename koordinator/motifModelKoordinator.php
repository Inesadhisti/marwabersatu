                  ...
                  <tbody>
                    <?php
                      ...
                      while ($row = $result->fetch_object()){
                        ...
                        echo "<td><a href='hapusMotif.php?user=$user&kode_motif=$row->kode_motif' onclick= 'return confirm()'><button style='font-size: 12px; ' type='button' class='btn btn-danger'>Hapus</button></a></td>";
                        echo "</tr>";
                      }
                    ?>
                  </tbody>
                  ...
                  <tbody>
                    <?php
                      ...
                      while ($row = $result->fetch_object()){
                        ...
                        echo "<td><a href='hapusModel.php?user=$user&kode_model=$row->kode_model' onclick= 'return confirm()'><button style='font-size: 12px; ' type='button' class='btn btn-danger'>Hapus</button></a></td>";
                        echo "</tr>";
                      }
                    ?>
                  </tbody>
