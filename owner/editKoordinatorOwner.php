  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <button style="font-size: 14px; " type='button' class='btn btn-success' data-toggle="modal" data-target="#editModal">Tambah Koordinator</button><br/><br/>
        <div class="col-md-10 portlets">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><strong>Data Koordinator</strong></h2>
              </div>
                  ...
                  <tbody>
                    <?php
                      ...
                      while ($row = $result->fetch_object()){
                        ...
                        echo "<td><a href='hapusKoordinator.php?user=$user&username=$row->username' onclick= 'return confirm()'><button style='font-size: 12px;' type='button' class='btn btn-danger'>Hapus</button></a></td>";
                        echo "</tr>";
                      }
                    ?>
                  </tbody>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="form" method="post" action="tambahKoordinator.php?user=<?php echo $user; ?>">
